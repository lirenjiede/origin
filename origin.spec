...
%{!?commit:
%global commit 5a34c809f28d9904b26f131c850252928df1e911
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_VERSION=v3.6.0-alpha.2+5a34c80-769 OS_GIT_MINOR=6+ OS_GIT_COMMIT=5a34c80 OS_GIT_MAJOR=3 OS_GIT_TREE_STATE=clean
}
